"""Dialog for transforming animated objects."""
import sys
sys.path.append('D:\code\snippets')
...
# TO DO: add checkbox for apply filter
...
class Version2Tab(QtWidgets.QWidget):
    ...
    def __init__(self, parent=None):
        ...
        main_layout.addWidget(apply_transform_button, 4, 0, 1, 2)
    ...
    def get_matrix_from_widget(self, widget):
        ...
        rotation = [widget.spinboxes['r'][axis].value() for axis in 'xyz']
        translation = [widget.spinboxes['t'][axis].value() for axis in 'xyz']
        rotation.append(1)
        transform_matrix.setRotationComponents(rotation)
    ...
    def apply_transform_to_selected(self):
        ...
        for obj in selection:
            ...
            pivot_matrix = self.get_matrix_from_widget(self.pivot_value_widget)
            if keys:
